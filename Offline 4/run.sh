...
java -Xmx500M -cp "/usr/local/lib/antlr-4.13.2-complete.jar:." org.antlr.v4.Tool -Dlanguage=Cpp -visitor C8086Lexer.g4
java -Xmx500M -cp "/usr/local/lib/antlr-4.13.2-complete.jar:." org.antlr.v4.Tool -Dlanguage=Cpp -visitor C8086Parser.g4
